...
export default function Register() {
    ...
    const { register } = useAuth(); // Grabbing the new function we just made
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await register(name, email, password); // Send data to backend
        ...
        <div style={S.page}>
            <div style={S.container}>
                <div style={S.card}>
                    ...
                    <p style={S.subtitle}>Join Aruna Cabs for premium VIP transport.</p>
